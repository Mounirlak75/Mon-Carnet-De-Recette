...
class AdminEtapeController extends AbstractController
{
    ...
    {
        return $this->render('admin_etape/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_etape/new.html.twig', [
            'etape' => $etape,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_etape/show.html.twig', [
            'etape' => $etape,
        ]);
    }
    ...
    public function edit(Request $request, Etape $etape, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_etape/edit.html.twig', [
            'etape' => $etape,
            'form' => $form,
        ]);
    }
